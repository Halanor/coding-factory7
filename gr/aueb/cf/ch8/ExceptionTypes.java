...
public class ExceptionTypes {
     ...
     * Since a checked exception is thrown, it has to be explicitly to be thrown in
     * method signature (στην επικεφαλιδα).
     * Or has to be caught{}
     * When this type of method / exception may be used?
     * When no need to handle the exception.
     * Is this meaningful? No. Ideally, we want to handle exceptions, not only propagate.
     *
     * @return
     * @throws IOException
     */
     ...
     * Is it a good practice, not do propagate?
    ...
    /**
     * In this type of method / exception, we take action -- logging, and also rethrow the exception
    ...
    /**
     * IllegalArgimentException is not necessary to be declated because it's a runtime. We add
     * it for readability reason.
     * @param ch
     * @return
     * @throws IOException
