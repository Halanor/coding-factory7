...
public class DateTimeToSecondsConverterProfessor {
    public static void main(String[] args) {
        ...
        totalSeconds = inputDays * SECONDS_PER_DAY + inputHours * SECONDS_PER_HOUR + inputMinutes *
                SECONDS_PER_MINUTE + inputSeconds;
